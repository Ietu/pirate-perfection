...
infamy_menu = function()
	local data = { 
		{ text = tr['set_inf'] .. ':', type = "slider", slider_data = { name = "inf_level", value = 0, max = 500 }, switch_back = true },
...
safehouse_menu = function()
	local data = {
		...
		{},
		{ text = tr['set_continental_coins'] .. ':', type = "slider", slider_data = { name = "set_continental_coins", value = 0, max = 100000 }, switch_back = true },
...
crimespree_menu = function()
	local data = {
		{},
		{ text = tr['set_crimespree_spree_level'] .. ":", type = "slider", slider_data = { name = "set_crimespree_spree_level", value = 0, max = 100000000 }, switch_back = true },
		{ text = tr['save'], type = "save_button", callback = set_crimespree_spree_level, name = "set_crimespree_spree_level" },
		{},
		{ text = tr['set_crimespree_reward_level'] .. ":", type = "slider", slider_data = { name = "set_crimespree_reward_level", value = 0, max = 100000000 }, switch_back = true },
		{ text = tr['save'], type = "save_button", callback = set_crimespree_reward_level, name = "set_crimespree_reward_level" },
		{},
		{ text = tr['set_crimespree_catchup_bonus'] .. ":", type = "slider", slider_data = { name = "set_crimespree_catchup_bonus", value = 0, max = 100000000 }, switch_back = true },
		{ text = tr['save'], type = "save_button", callback = set_crimespree_catchup_bonus, name = "set_crimespree_catchup_bonus" },
		{},
		{ text = tr['set_crimespree_winning_streak_bonus'] .. ":", type = "slider", slider_data = { name = "set_crimespree_winning_streak_bonus", value = 0, max = 100000000 }, switch_back = true },
