...
ppr_io.open = function( file, mode )
	file = "mods/[MOD] Pirate Perfection Reborn Trainer! Patron Edition/" .. file
...
ppr_io.io_popen = function( command )
	command = command:gsub("Trainer/", "mods/[MOD] Pirate Perfection Reborn Trainer! Patron Edition/Trainer/")
