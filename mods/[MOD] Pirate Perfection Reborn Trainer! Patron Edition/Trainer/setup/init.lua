...
local ME_VERSION = 'v2.0.0-PaE'
local ME_EDITION = 'Patron Edition'
local BLT_VERSION = '2.3 (r7_r19)'
...
backuper:hijack('TipsTweakData.get_a_tip', function(o, s)
	return math.random() > 0.8 and {image = "general_loot", index = 1, total = 1, title = "Pirate Perfection Reborn Trainer! Patron Edition", text = "Trainer: v2.0.0-PaE\nBLT: v2.3 (r7_r19)\nCreator: Baddog-11\nVisit us at www.Pirateperfection.com"} or o(s)
end)
