...
function Deathmatch:show_skill_gui( text )
	...
	self.skill_gui.lbl = self.skill_gui.ws:panel():text{ x = 270 + 0.5 * RenderSettings.resolution.x, y = -160 + 0.5 * RenderSettings.resolution.y, text = text, font = tweak_data.menu.pd2_large_font, font_size = 37, color = Color.Patron, layer = 2000 }
end
