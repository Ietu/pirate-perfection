-- Pirate Perfection Reborn Trainer! Patron Edition Main Configuration File.
...
-- General Options
 ...
 -- Spoof Options	
	NameSpoof = "eKore",		-- Your new name in game, set to false in order to use your steam name. Don't forget to write your name in "Quotation Marks" (Pro/VIP/Patron Function)
	ReduceDetectionLevel = false,					-- Reduce Detection Level (Pro/VIP/Patron Function)
 ...
 -- Anticheat related Options
	...
	non_modded_lobby = false,						-- Sets your Lobby to not Modded. (Pro/VIP/Patron Only Function)
