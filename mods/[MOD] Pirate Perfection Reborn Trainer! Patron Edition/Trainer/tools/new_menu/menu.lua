...
function Menu:add_title()
	...
	local title_text = main:text( { name = "title", text = title or "", layer = 2, wrap = false, word_wrap = false, visible = true,
								   font = T_menu.pd2_large_font, font_size = 20,color = Color.Patron,
...
function Menu:add_description()
	...
	local desc_panel = main:text( { name = "description", text = description or "", layer = 2, wrap = true, word_wrap = true, visible = true,
							   font = T_menu.pd2_medium_font, font_size = description_font_size, color = Color.Patron,
...
function Menu:add_lines() -- add top and bottom lines
	...
	local mid_line = main:bitmap( { name = "mid_line", texture = "guis/textures/headershadow", layer = 1, color = Color.Patron:with_alpha(1.0), w = w } )
	mid_line:set_bottom( th + dh + 2 )
	self.bottom_line = main:bitmap( { name = "bottom_line", texture = "guis/textures/headershadow", rotation = 180, layer = 1, color = Color.Patron:with_alpha(1.0), w = w } )
end
...
function Menu:add_buttons()
	...
	local text_config = { layer = 2, wrap = "true", word_wrap = "true", visible = true,
						  font = T_menu.pd2_medium_font, font_size = 20, color = Color.Patron,
	...
	for i, button in ipairs( button_list ) do
		...
		if button.menu then
			button_panel:bitmap( { texture = "guis/textures/pd2/crimenet_legend_join", color = Color.Patron, y = 3, x = button_panel:w() - 20 } )
		end
		
		if button.box then
			button_panel:bitmap( { texture = "guis/textures/pd2/blackmarket/inv_newdrop", color = Color.Patron, y = 3, x = button_panel:w() - 20 } )
		end
