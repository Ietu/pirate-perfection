...
function TextInput:create_gui()
	...
	local text_input = input_panel:text( { name = "input_text", text = "", font = pd2_small_font, font_size = pd2_small_font_size, x = 0, y = 0,
										...
										color = Color.Patron, layer = 5, wrap = true, word_wrap = false } )
										
	local caret = input_panel:rect( { name="caret", layer = 2, x = 0, y = 2, w = 0.8, h = panel:h() - 5, color = Color.Patron } )
