...
if not TerminatorHud then TerminatorHud = true
	...
	if	not	_G._HDmg	then
		...
		_HDmg.lbl	=	_HDmg.ws:panel():text{	name="lbl_"..tostring(math.random())	,	x	=	-900	+	0.5	*	RenderSettings.resolution.x,	y	=	-150	+	0.5	*	RenderSettings.resolution.y,	text="PPR-TH",	font=tweak_data.menu.pd2_large_font,	font_size	=	25,	color	=	Color.Patron,	layer=2000	}
		_HDmg.lbl:show()
		_HDmg.txts	=	{}
		_HDmg.lastTxt	=	''
	else
