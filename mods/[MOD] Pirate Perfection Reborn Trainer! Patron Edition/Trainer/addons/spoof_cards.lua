...
hijack(backuper, "IngameLobbyMenuState.set_lootdrop", function(o, self, drop_category, drop_item_id)
	...
	M_chat:_receive_message(1, tr.loot_spoof_name, tr.loot_spoof_actual..M_localization:text(T_blackmarket[temp.type_items][temp.item_entry].name_id), Color.Patron)
	local spoofs = {}
